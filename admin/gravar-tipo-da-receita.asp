...
oConexaoAdd.UpdateItem("UPDATE "&oConexaoAdd.prefixoTabela&"categoria_da_receita SET nome='"&varNome&"',data='"&varDataProjeto&"',registroIncluido='"&varRegistroIncluido&"',regTerminado='"&varRegistroTerminado&"',ultimaAlteracao='"&ultima_alteracao&"' WHERE id="&varIdProjeto)

response.redirect("lista-tipo-da-receita.asp?msg_sys=42")
%>