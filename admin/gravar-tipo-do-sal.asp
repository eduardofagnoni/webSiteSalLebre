...
oConexaoAdd.UpdateItem("UPDATE "&oConexaoAdd.prefixoTabela&"tipo_de_sal SET nome='"&varNome&"',data='"&varDataProjeto&"',registroIncluido='"&varRegistroIncluido&"',regTerminado='"&varRegistroTerminado&"',ultimaAlteracao='"&ultima_alteracao&"' WHERE id="&varIdProjeto)

response.redirect("lista-tipo-do-sal.asp?msg_sys=42")
%>