...
oPersists.UploadDeArquivo(oConexaoEdit.upReceita)

oConexaoEdit.UpdateItem("UPDATE "&oConexaoEdit.prefixoTabela&"receitas SET foto='"&oPersists.txtArquivo&"' WHERE id="&id)
