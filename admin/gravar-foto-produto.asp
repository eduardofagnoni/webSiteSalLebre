...
oPersists.UploadDeArquivo(oConexaoEdit.upProduto)

oConexaoEdit.UpdateItem("UPDATE "&oConexaoEdit.prefixoTabela&"produto SET foto='"&oPersists.txtArquivo&"' WHERE id="&id)
