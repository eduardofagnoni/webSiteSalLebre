...
if regIniciado="s" then
    ...
    oEditRegistro.AbreTabela("SELECT id,nome FROM "&oEditRegistro.prefixoTabela&"tipo_de_sal WHERE ativo='s' AND id="&id)
else
    'inclui o próximo registro e prepara o mesmo para edição.
    oAddRegistro.AddItem("INSERT INTO "&oAddRegistro.prefixoTabela&"tipo_de_sal (data, userIdSession, ultimaAlteracao) values ('"&dataInclusao&"','"&idUser&"','"&ultima_alteracao&"')")
    oEditRegistro.AbreTabela("SELECT id FROM "&oEditRegistro.prefixoTabela&"tipo_de_sal WHERE ativo='s' AND userIdSession="&idUser&" AND registroIncluido='n' ORDER BY id DESC")
    response.redirect("add-tipo-do-sal.asp?regIni=s&id="&oEditRegistro.rs("id"))
end if
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Adicionar Tipo do Sal <small></small></h1>
                <ol class="breadcrumb">
                    <li><a href="admin.asp"><i class="fa fa-home"></i> Home</a></li>
                    <li><a href="lista-tipo-do-sal.asp"><i class="fa fa-list"></i> Lista de Tipo do Sal</a></li>
                    <li class="active">Adicionar Tipo do Sal</li>
                </ol>
            </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h3 class="box-title">Tipo do Sal</h3>
                        </div>
                        
                        <div class="box-body">
                            <form class="form-horizontal form-label-left input_mask" method="post" action="gravar-tipo-do-sal.asp">  

                                <div class="row">                
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="sr-only" for="txtNome">Nome</label>
                                            <input type="text" class="form-control" id="txtNome" name="txtNome" placeholder="Tipo do Sal" value="<%=oEditRegistro.rs("nome")%>" required>
                                        </div>
                                    </div>                                    
                                </div>
                                ...
                                <div class="form-group" style="float:right">
                                    <button type="button" class="btnExtBt btTransparent" onclick="location.href='lista-tipo-do-sal.asp?msg_sys=44'">
