...
oConexaoDelete.AbreTabela("select foto from "&oConexaoDelete.prefixoTabela&"projeto where ativo='s' and id="&id)
...
'apagando registro
oConexaoDelete.UpdateItem("DELETE from "&oConexaoDelete.prefixoTabela&"projeto WHERE id="&id)
