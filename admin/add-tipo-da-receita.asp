...
if regIniciado="s" then
    ...
    oEditRegistro.AbreTabela("SELECT id,nome FROM "&oEditRegistro.prefixoTabela&"categoria_da_receita WHERE ativo='s' AND id="&id)
else
    'inclui o próximo registro e prepara o mesmo para edição.
    oAddRegistro.AddItem("INSERT INTO "&oAddRegistro.prefixoTabela&"categoria_da_receita (data, userIdSession, ultimaAlteracao) values ('"&dataInclusao&"','"&idUser&"','"&ultima_alteracao&"')")
    oEditRegistro.AbreTabela("SELECT id FROM "&oEditRegistro.prefixoTabela&"categoria_da_receita WHERE ativo='s' AND userIdSession="&idUser&" AND registroIncluido='n' ORDER BY id DESC")
    response.redirect("add-tipo-da-receita.asp?regIni=s&id="&oEditRegistro.rs("id"))
end if
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Adicionar Tipo da Receita <small></small></h1>
                <ol class="breadcrumb">
                    <li><a href="admin.asp"><i class="fa fa-home"></i> Home</a></li>
                    <li><a href="lista-tipo-da-receita.asp"><i class="fa fa-list"></i> Lista de Tipo da Receita</a></li>
                    <li class="active">Adicionar Tipo da Receita</li>
                </ol>
            </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h3 class="box-title">Tipo da Receita</h3>
                        </div>
                        
                        <div class="box-body">
                            <form class="form-horizontal form-label-left input_mask" method="post" action="gravar-tipo-da-receita.asp">  

                                <div class="row">                
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="sr-only" for="txtNome">Nome</label>
                                            <input type="text" class="form-control" id="txtNome" name="txtNome" placeholder="Tipo da Receita" value="<%=oEditRegistro.rs("nome")%>" required>
                                        </div>
                                    </div>                                    
                                </div>
                                ...
                                <div class="form-group" style="float:right">
                                    <button type="button" class="btnExtBt btTransparent" onclick="location.href='lista-tipo-da-receita.asp?msg_sys=44'">
