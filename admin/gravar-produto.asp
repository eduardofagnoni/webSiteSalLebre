...
varTipoSal = SafeSQL(request.form("txtTipoDeSal"))
VarUsoSal = SafeSQL(request.form("txtUsoDoSal"))
...
oConexaoAdd.UpdateItem("UPDATE "&oConexaoAdd.prefixoTabela&"produto SET idTipo='"&varTipoSal&"',idUso='"&VarUsoSal&"',nome='"&varNome&"',resumo='"&varResumo&"',embalagens='"&varEmbalagem&"',data='"&varDataProjeto&"',registroIncluido='"&varRegistroIncluido&"',regTerminado='"&varRegistroTerminado&"',ultimaAlteracao='"&ultima_alteracao&"' WHERE id="&varIdProjeto)

response.redirect("lista-produto.asp?msg_sys=42")
%>